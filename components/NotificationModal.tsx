...
const NOTIF_ICONS: Record<NotificationType, { name: string; color: string }> = {
  ...
  gig_completed: { name: 'checkmark-done', color: '#19A7A8' },
  new_gig: { name: 'megaphone-outline', color: '#0891b2' },
  withdrawal: { name: 'arrow-down-circle', color: '#19A7A8' },
  verification_complete: { name: 'shield-checkmark', color: '#16a34a' },
  id_verified: { name: 'id-card', color: '#19A7A8' },
  gig_funded: { name: 'card-outline', color: '#19A7A8' },
